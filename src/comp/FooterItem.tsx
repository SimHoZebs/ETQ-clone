...
const FooterItem = (props: Props) => {
  ...
  return (
    <div class={"flex flex-col gap-y-1 " + props.class}>
      ...
      <div
        class={`overflow-hidden text-sm duration-300 lg:max-h-20 ${
          visible ? "max-h-20 " : "max-h-0 delay-300 "
        }`}
      >
        <div
          class={`mb-2 flex flex-col gap-y-2 delay-300 duration-300 lg:text-black ${
      ...
      <hr class="border-gray-300 lg:hidden"></hr>
    </div>
  );
};
